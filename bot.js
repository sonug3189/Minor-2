...
function go_live(follow_reply , tweet_reply)
{
	...
	// 	});
		...
		// fs.writeFile("test_file.txt",event['text'],function(err,data){if(err){console.log(err);}});
...
go_live("Thanks for mentioning me Buddy !" , "Service Ready");
